...
class Triage(models.Model):
    ...
    admintion_date = models.DateField('تاریخ مراجعه',null=True)
 ...
 #----Airway_hazard---
    respiratory_distress = models.BooleanField('دیسترس تنفس')
    airway_risk = models.BooleanField('مخاطره راه هوایی')
    cyanosis = models.BooleanField('سیانوز')
    shock_symptoms = models.BooleanField('علایم شوک')
    Spo2_90 = models.BooleanField('Spo2<90')
 ...
 #---بیماران پرخطر (سطح 3)---
    ...
    emergency_department = models.CharField('ارجاع به کدام قسمت بخش اورژانس',max_length=25,choices=emergency_department_choices)
